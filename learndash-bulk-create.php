 ...
 * Text Domain: learndash-bulk-create
...
function learndash_bulk_create_activate() {
    ...
    if (!is_plugin_active('sfwd-lms/sfwd_lms.php')) {
        ...
        wp_die(__('Please install and activate LearnDash before activating this plugin.', 'learndash-bulk-create'));
    }
}
